...
import type { DashboardStats, WeeklyMuscleSets } from "@/lib/queries/workouts";
...
export function DashboardPane({
  ...
  firstName: string;
  unit: "KG" | "LB";
  activeWorkout: { id: string; name: string | null } | null;
        ...
        >
          {activeWorkout ? (
            <Button asChild size="lg">
              <Link href={`/dashboard/workouts/${activeWorkout.id}`}>
          ...
          <Card className="from-primary/10 bg-gradient-to-b to-transparent">
            <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
              ...
              <p className="text-muted-foreground max-w-sm text-sm">
                Log your first workout and this dashboard turns into a scoreboard —
                streaks, total weight lifted, weekly progress.
              </p>
