...
import type { WorkoutSummary } from "@/lib/queries/workouts";
...
export function WorkoutsPane({ workouts }: { workouts: WorkoutSummary[] }) {
  return (
    <Pane>
          ...
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
            {workouts.map((w) => (
              ...
              >
                <Card
                  size="sm"
                  className="group-hover:ring-primary/30 h-full transition-shadow [contain-intrinsic-size:auto_7rem] [content-visibility:auto]"
                >
                  <CardHeader>
